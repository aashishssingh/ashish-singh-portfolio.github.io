...
work on the site — match it rather than inventing new patterns.
...
- Test new pages at ≤900px and ≤580px — the responsive breakpoints collapse multi-column grids to one column there.
